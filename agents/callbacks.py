...
class WandbCallback(rl.callbacks.LoggingCallback):
    ...
    def _update_wandb(self, prefix, metrics_list:rl.callbacks.logging_callback.MetricList, logs=None):
